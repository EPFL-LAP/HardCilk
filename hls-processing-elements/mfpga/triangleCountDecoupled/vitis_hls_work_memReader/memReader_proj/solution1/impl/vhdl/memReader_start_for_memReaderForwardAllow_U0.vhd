...
entity memReader_start_for_memReaderForwardAllow_U0 is 
    generic (
...
architecture rtl of memReader_start_for_memReaderForwardAllow_U0 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component memReader_start_for_memReaderForwardAllow_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_memReader_start_for_memReaderForwardAllow_U0_ShiftReg : memReader_start_for_memReaderForwardAllow_U0_ShiftReg
    generic map (
...
entity memReader_start_for_memReaderForwardAllow_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end memReader_start_for_memReaderForwardAllow_U0_ShiftReg;

architecture rtl of memReader_start_for_memReaderForwardAllow_U0_ShiftReg is
