...
int main(int argc, char* argv[])
{
    ...
    auto pr0_name = "triangleCount_0:{triangleCount_0}";
    ...
    auto triangleCount_0= xrt::ip(fpga_card[0], uuids[0], pr0_name);



    auto triangleCount_1 = xrt::ip(fpga_card[1], uuids[1], pr0_name);

  

    std::vector<Memory *> memories_;

    auto memory_0 = XRTMemory(fpga_card[0], triangleCount_0);
    auto memory_1 = XRTMemory(fpga_card[1], triangleCount_1);
