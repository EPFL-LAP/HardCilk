...
int hardCilkDriver::checkFinished()
{
    ...
    //     "arbiterToMfpgaNetwork.sources(0) : valid=%llu, ready=%llu\n"
    //     "arbiterToMfpgaNetwork.sources(1) : valid=%llu, ready=%llu\n"
    //     "arbiterToMfpgaNetwork.sources(2) : valid=%llu, ready=%llu\n"
    //     "arbiterToMfpgaNetwork.sources(3) : valid=%llu, ready=%llu\n"
    //     "arbiterToMfpgaNetwork.select : valid=%llu, ready=%llu\n"

    //     "m_axis_ever_blocked = %llu\n"
    //     "s_axis_ever_blocked = %llu\n"
    //     "s_axis_mFPGA_argServers_ever_blocked = %llu\n"
    //     "s_axis_mFPGA_schedulers_ever_blocked = %llu\n"
    //     "s_axis_mFPGA_memAccess_ever_blocked = %llu\n"

    //     "m_axis_mFPGA.get : valid=%llu, ready=%llu\n"
    //     "s_axis_mFPGA.get : valid=%llu, ready=%llu\n"
    //     "s_axis_mFPGA_argServers.get : valid=%llu, ready=%llu\n"
    //     "s_axis_mFPGA_schedulers.get : valid=%llu, ready=%llu\n"
    //     "s_axis_mFPGA_memAccess.get : valid=%llu, ready=%llu\n",
    ...
    //     "write_response_sinks[7] : valid=%llu, ready=%llu\n"
    //     "write_response_sinks[6] : valid=%llu, ready=%llu\n"
    //     "write_response_sinks[5] : valid=%llu, ready=%llu\n"
    //     "write_response_sinks[4] : valid=%llu, ready=%llu\n"
    //     "write_response_sinks[3] : valid=%llu, ready=%llu\n"
    //     "write_response_sinks[2] : valid=%llu, ready=%llu\n"
    //     "write_response_sinks[1] : valid=%llu, ready=%llu\n"
    //     "write_response_sinks[0] : valid=%llu, ready=%llu\n"

    //     "local_write_modules_info.deq : valid=%llu, ready=%llu\n"
    //     "io.s_axis_remote : valid=%llu, ready=%llu\n"
    //     "io.m_axis_remote : valid=%llu, ready=%llu\n"
    //     "m_axi_mem.w : valid=%llu, ready=%llu\n"
    //     "m_axi_mem.r : valid=%llu, ready=%llu\n"
    //     "m_axi_mem.b : valid=%llu, ready=%llu\n"
    //     "m_axi_mem.aw : valid=%llu, ready=%llu\n"
    //     "m_axi_mem.ar : valid=%llu, ready=%llu\n"
    //     "local_modules_req_arbiter.select : valid=%llu, ready=%llu\n"
    //     "local_modules_req_arbiter.sink : valid=%llu, ready=%llu\n"
    //     "mfpga_master_arbiter.sources(0) : valid=%llu, ready=%llu\n"
    //     "mfpga_master_arbiter.sources(1) : valid=%llu, ready=%llu\n"
    //     "mfpga_master_arbiter.sources(2) : valid=%llu, ready=%llu\n"
    //     "write_responses : valid=%llu, ready=%llu\n"
    //     "read_responses : valid=%llu, ready=%llu\n"
    //     "read_requests : valid=%llu, ready=%llu\n"
    //     "write_requests : valid=%llu, ready=%llu\n"
    //     "receiveQueue.enq : valid=%llu, ready=%llu\n"
    //     "receiveQueue.deq : valid=%llu, ready=%llu\n",
    ...
    //     "io.connNetwork : valid=%llu, ready=%llu\n"
    //     "remoteQSend.enq : valid=%llu, ready=%llu\n"
    //     "localQ.enq : valid=%llu, ready=%llu\n"
    //     "remoteQRec.deq : valid=%llu, ready=%llu\n"
    //     "localQ.deq : valid=%llu, ready=%llu\n"
    //     "arbiterToLocalServer.select : valid=%llu, ready=%llu\n"
    //     "arbiterToRemoteFPGA.select : valid=%llu, ready=%llu\n"
    //     "argument_notification.m_axis : valid=%llu, ready=%llu\n"
    //     "argument_notification.s_axis : valid=%llu, ready=%llu\n"
    //     "reset_send_counter.m_axis : valid=%llu, ready=%llu\n"
    //     "reset_send_counter.s_axis : valid=%llu, ready=%llu\n"
    //     "arbiterToRemoteFPGA.sink : valid=%llu, ready=%llu\n"
    //     "arbiterToLocalServer.sink : valid=%llu, ready=%llu\n",
