...
axs[0, 0].set_title("(a) Benchmark 1, 16 tasks per request")
...
axs[0, 1].set_title("(b) Benchmark 1, 32 tasks per request")
...
axs[0, 2].set_title("(c) Benchmark 1, 64 tasks per request")
...
axs[0, 3].set_title("(d) Benchmark 1, 128 tasks per request")
...
axs[1, 0].set_title("(e) Benchmark 2, 16 tasks per request")
...
axs[1, 1].set_title("(f) Benchmark 2, 32 tasks per request")
...
axs[1, 2].set_title("(g) Benchmark 2, 64 tasks per request")
...
axs[1, 3].set_title("(h) Benchmark 2, 128 tasks per request")
...
axs[2, 0].set_title("(i) Benchmark 3, 16 tasks per request")
...
axs[2, 1].set_title("(j) Benchmark 3, 32 tasks per request")
...
axs[2, 2].set_title("(k) Benchmark 3, 64 tasks per request")
...
axs[2, 3].set_title("(l) Benchmark 3, 128 tasks per request")
