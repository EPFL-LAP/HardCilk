...
class graphDaeDriver: public hardCilkDriver
{
    public:
    
    graphDaeDriver(Memory * memory): hardCilkDriver(memory) {}
    ...
    int run_test_bench() override {
        ...
        visit_cont0_task visit_cont0_task_0 = {TOTAL_NODES+1, 0, 0, 0, {1,0,0}, {0}};
        ...
        visit_task args = {
            ...
            .g = g_fpga,
            .n = (addr_t)nodes_fpga,
            ._padding = {0, 0, 0, 0, 0, 0, 0, 0} // padding to align to 64 bits
        };
