...
int main(int argc, char* argv[])
{
    ...
    auto pr0_name = "triangleCount:{triangleCount_0}";
    auto pr1_name = "triangleCount:{triangleCount_1}";
    ...
    if(enable_alveo_link){
        ...
        pr0_name = "triangleCount_0:{triangleCount_0}";
        pr1_name = "triangleCount_1:{triangleCount_1}";
    }



    auto triangleCount_0 = xrt::ip(device, uuid, pr0_name);
    auto triangleCount_1 = xrt::ip(device, uuid, pr1_name);


    std::vector<Memory *> memories_;

    auto memory_0 = XRTMemory(device, triangleCount_0);
    auto memory_1 = XRTMemory(device, triangleCount_1);

    memories_.push_back(&memory_0);
    memories_.push_back(&memory_1);
    

    triangleCountDriver driver(memories_, graph_file);
