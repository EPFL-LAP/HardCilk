...
base_series = [value for file, value in data_points[6:12]]

print(single_pe)
print(base_series)

base_series = (np.array(single_pe) / 128 / np.array(base_series)) * 100
...
axs[0].set_title("Benchmark 2, 16 task per request")
axs[0].set_ylabel("Efficiency (%)")
axs[0].set_xlabel("Task Delay (Cycles)")
axs[0].plot(x_axis, base_series, marker='o', label='1 FPGA')
axs[0].plot(x_axis, sweep_2_2_16, marker='s', label='2 FPGA')
axs[0].plot(x_axis, sweep_2_3_16, marker='^', label='4 FPGA')
axs[0].plot(x_axis, sweep_2_4_16, marker='x', label='8 FPGA')
axs[0].set_ylim(20, 101)
axs[0].set_xlim(0, 512)
axs[0].legend(loc='lower right')
axs[0].grid(True, which='both', linestyle='--', linewidth=1, alpha=0.7, color='gray')  

axs[1].set_title("Benchmark 2, 32 task per request")
axs[1].set_ylabel("Efficiency (%)")
axs[1].set_xlabel("Task Delay (Cycles)")
axs[1].plot(x_axis, base_series, marker='o', label='1 FPGA')
axs[1].plot(x_axis, sweep_2_2_32, marker='s', label='2 FPGA')
axs[1].plot(x_axis, sweep_2_3_32, marker='^', label='4 FPGA')
axs[1].plot(x_axis, sweep_2_4_32, marker='x', label='8 FPGA')
axs[1].set_ylim(20, 101)
axs[1].set_xlim(0, 512)
axs[1].legend(loc='lower right')
axs[1].grid(True, which='both', linestyle='--', linewidth=1, alpha=0.7, color='gray')  

axs[2].set_title("Benchmark 2, 64 task per request")
axs[2].set_ylabel("Efficiency (%)")
axs[2].set_xlabel("Task Delay (Cycles)")
axs[2].plot(x_axis, base_series, marker='o', label='1 FPGA')
axs[2].plot(x_axis, sweep_2_2_64, marker='s', label='2 FPGA')
axs[2].plot(x_axis, sweep_2_3_64, marker='^', label='4 FPGA')
axs[2].plot(x_axis, sweep_2_4_64, marker='x', label='8 FPGA')
axs[2].set_ylim(20, 101)
axs[2].set_xlim(0, 512)
axs[2].legend(loc='lower right')
axs[2].grid(True, which='both', linestyle='--', linewidth=1, alpha=0.7, color='gray')  

axs[3].set_title("Benchmark 2, 128 task per request")
axs[3].set_ylabel("Efficiency (%)")
axs[3].set_xlabel("Task Delay (Cycles)")
axs[3].plot(x_axis, base_series, marker='o', label='1 FPGA')
axs[3].plot(x_axis, sweep_2_2_128, marker='s', label='2 FPGA')
axs[3].plot(x_axis, sweep_2_3_128, marker='^', label='4 FPGA')
axs[3].plot(x_axis, sweep_2_4_128, marker='x', label='8 FPGA')
axs[3].set_ylim(20, 101)
...
plt.tight_layout()
plt.savefig('Benchmark2.pdf', dpi=300)