...
import Util.{MemReq, RemoteWriteBuffer, RemoteWriteBufferConfig, WriteBufferLast,
  WriteBufferLastConfig, WriteBufferModule, WriteResp}
...
class WriteBuffer(
  ...
  val s_releaseMetadata: Option[axi4s.Interface] = None
