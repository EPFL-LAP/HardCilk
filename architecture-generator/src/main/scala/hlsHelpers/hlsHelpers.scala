...
/**
  * An object with a function that when given a task descriptor, returns an array of VitisModules.
  * The task descriptor has the path to the hdl directory and the name of the module.
  * One function passes the path to another function that parses the <module>.v from the hdl directory
  * and returns a vitisModuleConfig.
  */
