...
import tclResources.tclGeneralConfigs
...
object testTclGeneratorCompute extends App {

    val tclFileDirectory = "output"
    val pathInputJsonFile = "taskDescriptors/qsort_descriptor.json"
    val tclGen = new tclGeneratorCompute(parseJsonFile[fullSysGenDescriptor](pathInputJsonFile), tclFileDirectory)
}