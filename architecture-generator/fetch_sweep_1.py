...
files = [f for f in files if "networkLatency" in f]
...
axs[0].set_title("(a) Benchmark 1, 16 task per request")
...
plt.tight_layout()
plt.savefig('Benchmark1_2048.pdf', dpi=300)